...
### 3.MINI-MUNDO<br>
Uma doação é um ato de ajuda voluntária onde uma pessoa dá algo a outra, sem esperar nada em troca.  Doações existem justamente porque existe alguma pessoa ou organização com necessidades e alguém com melhor condição pode realizar essa ajuda. Entretanto, nem sempre a conexão entre essas duas partes ocorre, seja por falta de um meio apropriado para isso.<br>
O sistema “AppDoações” tem o intuito de ser um mediador entre um doador e receptor, tornando mais prática, confiável e eficiente a comunicação entre ambos e a concretização das doações. O sistema permite que pessoas e ONGs divulguem itens que queiram doar e possam ter contato com outras pessoas que necessitem daquele item. E também que possam divulgar necessidades a fim de encontrar um doador disposto a ajudar. Através do contato entre doador e receptor, em caso de doações, o doador pode decidir com quem, quando e onde concretizará a doação. Em caso de necessidade, o necessitado escolhe com quem, quando e onde receberá a ajuda. As doações e necessidades são encontradas através de buscas por nome e categoria.<br>
O sistema contará com uma moeda virtual usada para fazer solicitações de itens e divulgação de necessidades, assim fazendo um controle dessas ações para que ninguém tire proveito do sistema para conseguir a maior quantidade de doações possíveis sem que necessite. Ao ser um doador de qualquer doação concretizada, a pessoa é recompensada pela quantia prevista pela categoria da doação.
<br>
