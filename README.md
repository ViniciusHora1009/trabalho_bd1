...
### 3.MINI-MUNDO<br>
Uma doação é um ato de ajuda voluntária onde uma pessoa dá algo a outra, sem esperar nada em troca.  Doações existem justamente porque existe alguma pessoa ou organização com necessidades e alguém com melhor condição pode realizar essa ajuda. Entretanto, nem sempre a conexão entre essas duas partes ocorre, seja por falta de um meio apropriado para isso.
